          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {inProgressOrders.map((order) => (
                <div
                  key={order.id}
                  className="p-5 bg-surface-container-high/40 rounded-xl border border-white/50 backdrop-blur-sm hover:bg-surface-container-high transition-colors"
                >
